                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    width: MediaQuery.of(context).size.width *
                                        0.2, // Responsive width (20% of screen)
...
// // below is the new version of above code in to make myaddetailscreen to fetch ad
// import 'package:carhive/models/ad_model.dart' show AdModel;
// import 'package:carhive/store/global_ads.dart' show GlobalAdStore;
// import 'package:flutter/material.dart';
// import 'package:image_picker/image_picker.dart';
...
// class PostAdCar extends StatefulWidget {
//   final String adId; // Required parameter for editing

//   const PostAdCar({super.key, required this.adId});
...
//           await GlobalAdStore().updateAd(widget.adId, updatedAd);
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(content: Text('Ad updated successfully!')),
//           );
//         } else {
//           await GlobalAdStore().addAd(updatedAd);
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(
//                 content: Text(
//                     'Your ad has been submitted for review. You will be notified once it\'s approved.')),
...
//       } catch (e) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text('Failed to post/update ad: $e')),
//         );
//       }
//     }
//   }
...
//         future: widget.adId.isNotEmpty
//             ? FirebaseFirestore.instance
//                 .collection('ads')
//                 .doc(widget.adId)
//                 .get()
//                 .then((doc) => doc.exists
//                     ? AdModel.fromFirestore(
...
//             _mileageController.text = ad.mileage ?? '';
//             _fuelController.text = ad.fuel ?? '';
//             _bodyColorController.text = ad.bodyColor ?? '';
//             _kmsController.text = ad.kmsDriven ?? '';
...
//             selectedCarModel = ad.year;
//             selectedRegisteredIn = ad.registeredIn;
//           }
