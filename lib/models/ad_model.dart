...
class AdModel {
  ...
  // ✅ New field for 3D view (list of image URLs)
  final List<String>? carImages360;
  ...
  /// ✅ Fix: Added parser for createdAt (Timestamp, String, or int)
  static DateTime? _parseCreatedAt(dynamic value) {
    if (value == null) return null;
    if (value is Timestamp) return value.toDate();
    if (value is String) {
  ...
  factory AdModel.fromFirestore(Map<String, dynamic> data, String documentId) {
    return AdModel(
      ...
      name: data['name'],
      phone: data['phone'],
      carImages360: data['carImages360'] != null
          ? List<String>.from(data['carImages360'])
          : [],
    );
  }
